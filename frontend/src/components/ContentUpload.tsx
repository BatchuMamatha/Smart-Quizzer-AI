...
const ContentUpload: React.FC<ContentUploadProps> = ({ onContentProcessed, onError, className = '' }) => {
  ...
  return (
    <div className={`bg-white dark:bg-gray-800 rounded-xl shadow-lg border-2 border-gray-200 dark:border-gray-700 ${className}`}>
      {/* Method Selection */}
            ...
            <button
              ...
              className={`flex items-center px-4 py-2 rounded-lg border-2 text-sm font-medium transition-all duration-200 ${
                uploadMethod === method.key
                  ...
                  : 'border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:border-blue-300 dark:hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20'
              }`}
            >
        ...
        {uploadMethod === 'text' && (
          <div className="space-y-4">
            ...
            <textarea
              ...
              rows={8}
              className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg resize-none focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 placeholder-gray-500 dark:placeholder-gray-400"
            />
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
                or <span className="text-blue-500 dark:text-blue-400 font-medium">click to browse</span>
              </p>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-200 dark:focus:ring-blue-800 placeholder-gray-500 dark:placeholder-gray-400"
              />
              <button
                onClick={processUrl}
      ...
      {processingResult && (
        <div className="mx-6 mb-6 p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
          <div className="flex items-start">
            <span className="text-green-500 dark:text-green-400 text-xl mr-3 mt-1">✅</span>
            <div className="flex-1">
              <h4 className="font-semibold text-green-800 dark:text-green-400 mb-2">Content Processed Successfully!</h4>
              
              {processingResult.summary && (
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                  <div>
                    <span className="text-green-600 dark:text-green-400 font-medium">Words:</span>
                    <p className="text-green-800 dark:text-green-300">{processingResult.summary.word_count}</p>
                  </div>
                  <div>
                    <span className="text-green-600 dark:text-green-400 font-medium">Reading Time:</span>
                    <p className="text-green-800 dark:text-green-300">{processingResult.summary.estimated_reading_time} min</p>
                  </div>
                  <div>
                    <span className="text-green-600 dark:text-green-400 font-medium">Content Hash:</span>
                    <p className="text-green-800 dark:text-green-300 font-mono text-xs">
              ...
              {processingResult.summary?.content_preview && (
                <div className="mt-3 p-3 bg-white dark:bg-gray-700 rounded border dark:border-gray-600">
                  <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Content Preview:</p>
                  <p className="text-sm text-gray-800 dark:text-gray-200">{processingResult.summary.content_preview}</p>
                </div>
              )}
            </div>
          </div>
