...
const Header: React.FC<HeaderProps> = ({ 
  ...
  return (
    <header className="bg-white bg-opacity-80 dark:bg-gray-800 dark:bg-opacity-80 backdrop-blur-md shadow-lg border-b border-white border-opacity-20 dark:border-gray-700 sticky top-0 z-40">
        ...
        <div className="flex justify-between items-center py-6">
          ...
          <div className="flex items-center space-x-3 animate-slide-in-right">
            ...
            <button
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:shadow-lg transform hover:-translate-y-1 transition-all duration-200 whitespace-nowrap"
            >
              {user?.avatar_url ? (
                <img
